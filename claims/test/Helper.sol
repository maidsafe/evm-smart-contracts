...
abstract contract Helper is Test {
    ...
    function forkArbitrumSepolia() internal {
        uint256 _forkId = vm.createFork(vm.envString("ARB_SEPOLIA_RPC_URL"));
        forkIds[Forks.ARB_SEPOLIA] = _forkId;
    }
    ...
    function selectArbSepolia() internal {
        uint256 forkId = forkIds[Forks.ARB_SEPOLIA];
        vm.selectFork(forkId);
    }
